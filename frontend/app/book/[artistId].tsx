  ...
  const pickImage = async (kind: "reference" | "receipt") => {
    try {
      ...
      if (kind === "reference") {
        ...
        // Selecting a new receipt always replaces any previously selected receipt/URL.
